                                    ...
                                    @foreach($users as $user)
                                        ...
                                        <tr>
                                            ...
                                            <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                                <a href="/manage/users/{{ $user->id }}" target="_blank"
                                                   class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                <form class="inline" method="POST" action="/manage/users/{{ $user->id }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="#" class="text-indigo-600 hover:text-indigo-900" onclick="event.preventDefault('form'); this.closest('form').submit()">Delete<span class="sr-only"></span></a>
                                                </form>
