<x-casteaching-layout>
    ...
    <div id="layout_series_navigation" class="min-h-full" x-data="{ open: false }">
        ...
        <div x-show="open" class="fixed inset-0 flex z-40 lg:hidden" role="dialog" aria-modal="true">
            ...
            <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
                ...
                <div class="flex-shrink-0 flex items-center px-4">
                    <img class="w-10 h-10 bg-gray-300 rounded-full flex-shrink-0 mr-2"
                         src="/storage/{{ $video->serie?->image_url }}" alt="">
                        ...
                        <div class="space-y-1">
                            @foreach ($videos_series as $sVideo)
                                @if ($sVideo->is($video))
                                    ...
                                    <a href="/videos/{{ $sVideo->id }}"
                                       class="bg-gray-100 w-80 text-gray-900 group flex items-center px-2 py-2 text-base leading-5 font-medium rounded-md"
                                       aria-current="page">
                                        <!--
                                        ...
                                        <span class="w-64 truncate"
                                              title="{{ $sVideo->title }}">{{ $sVideo->title }}</span>
                                    </a>
                                @else
                                    <a href="/videos/{{ $sVideo->id }}"
                                       class="text-gray-600 w-80 hover:text-gray-900 hover:bg-gray-50 group flex items-center px-2 py-2 text-base leading-5 font-medium rounded-md">
        ...
        <div
            class="hidden lg:flex lg:flex-col lg:w-96 lg:fixed lg:top-[64px] lg:bottom-0 lg:border-r lg:border-gray-200 lg:pt-5 lg:pb-4 lg:bg-gray-100">
                ...
                <nav class="px-3 mt-6 overflow-y-auto">
                    <div class="space-y-1">
                        @foreach ($videos_series as $sVideo)
                            @if ($sVideo->is($video))
                                ...
                                <a href="#" class="w-80 bg-gray-200 text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md" aria-current="page">
                                    <!--
                                      ...
                                      Current: "text-gray-500", Default: "text-gray-400 group-hover:text-gray-500"
                                    -->
                                    <svg class="text-gray-500 mr-3 flex-shrink-0 svg-triangle h-6 w-6"
                                         xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                              d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                            ...
                            @else
                                <a href="/videos/{{ $sVideo->id }}"
                                   class="text-gray-700 w-80 hover:text-gray-900 hover:bg-gray-50 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                    <svg class="text-gray-500 mr-3 flex-shrink-0 h-6 w-6"
                                         xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
